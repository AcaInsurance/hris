...
public class LoadAbsensiForCancellationAdapter extends RecyclerView.Adapter<LoadAbsensiForCancellationAdapter.ViewHolder> {
    public static String BUNDLE_NO_TRANSAKSI = "BUNDLE_NO_TRANSAKSI";

    public List<FormListForCancellationModel> arrList;
    public Context context;
    public Activity activity;


    public LoadAbsensiForCancellationAdapter(Activity activity, List<FormListForCancellationModel> arrList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_absensi_for_cancellation_row, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        FormListForCancellationModel map = arrList.get(position);
        ...
        holder.txtAlasan.setText(map.Alasan);
