...
public class CutiAdapter extends RecyclerView.Adapter<CutiAdapter.ViewHolder> {
    ...
    public List<CutiListModel> arrList;
    public Context context;
    public Activity activity;

    public CutiAdapter(Activity activity, List<CutiListModel> arrList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final CutiListModel formList = arrList.get(position);
        holder.txtTanggalTranskasi.setText(UtilDate.format(formList.TanggalTransaksi, UtilDate.DATE_TIME_PATTERN_SERVER, UtilDate.DATE_PATTERN_DISPLAY_2));
        holder.txtNamaKaryawan.setText(formList.NamaKaryawan);
        holder.txtNoTransaksi.setText(formList.NoTransaksi);
        holder.txtTipeForm.setText(formList.NamaCuti);
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(activity, CutiActivity.class);
    ...
    private void bindWatermark(ViewHolder holder, CutiListModel formList) {
    ...
    private boolean isReviewed(CutiListModel list) {
    ...
    private void setStatus(ViewHolder holder, CutiListModel list) {
