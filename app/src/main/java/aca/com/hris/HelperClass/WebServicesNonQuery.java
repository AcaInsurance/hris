...
public abstract class WebServicesNonQuery extends AsyncTask {
    ...
    public WebServicesNonQuery(@NonNull Context context
    ...
    protected abstract void onSuccess(ArrayList<HashMap<String, String>> arrList);
